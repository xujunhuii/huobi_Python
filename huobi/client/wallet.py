...
class WalletClient(object):
    ...
    def get_account_deposit_address(self, currency: "str") -> list:
        ...
        from huobi.service.wallet.get_account_deposit_address import (
            GetAccountDepositAddressService,
        )
    ...
    def get_account_withdraw_quota(self, currency: "str") -> list:
        ...
        from huobi.service.wallet.get_account_withdraw_quota import (
            GetAccountWithdrawQuotaService,
        )
    ...
    def get_sub_user_deposit_history(
        ...
        from huobi.service.wallet.get_sub_user_deposit_history import (
            GetSubUserDepositHistoryService,
        )
    ...
    def get_sub_user_deposit_address(self, sub_uid: "int", currency: "str") -> list:
        ...
        from huobi.service.wallet.get_sub_user_deposit_address import (
            GetSubUserDepositAddressService,
        )
    ...
    def get_account_withdraw_address(
        ...
        from huobi.service.wallet.get_account_withdraw_address import (
            GetAccountWithdrawAddressService,
        )
