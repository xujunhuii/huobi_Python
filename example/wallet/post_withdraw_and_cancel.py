...
withdraw_id = wallet_client.post_create_withdraw(
    address="xxxxxx", amount=40, currency="trx", fee=1, chain=None, address_tag=None
)
...
LogInfo.output(
    "Cancel Withdraw Id {id} {response_id}".format(
...
withdraw_id_ret = wallet_client.post_cancel_withdraw(withdraw_id=withdraw_id)
LogInfo.output(
    "Cancel Withdraw {withdraw_id}, {response_id}".format(
